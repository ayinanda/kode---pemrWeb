...
<body>
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <a href="index.php?action=salary_stats" class="nav-link">Salary Stats</a>
            <a href="index.php?action=tenure_stats" class="nav-link">Tenure Stats</a>
            <a href="index.php?action=overview_employees" class="nav-link">Overview</a>
        </nav>
